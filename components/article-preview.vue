<template>
  <nuxt-link
    :to="slug"
    class="block p-1 lg:p-4 space-y-1 lg:space-y-4 shadow-xs"
  >
    <h2 class="text-xl lg:text-3xl font-semibold text-accent-color">
      {{ name }}
    </h2>
    <span class="text-sm text-gray-600">Published on {{ publishDate }} </span>
  </nuxt-link>
</template>
<script>
